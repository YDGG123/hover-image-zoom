...
[![Version](https://img.shields.io/badge/version-3.3.1-blue)](https://github.com/你的用户名/仓库名/releases)
[![License](https://img.shields.io/badge/license-MIT-green)](./LICENSE)
[![Greasy Fork](https://img.shields.io/badge/Greasy%20Fork-安装-red)](https://greasyfork.org/zh-CN/scripts/你的脚本ID)
[![ScriptCat](https://img.shields.io/badge/脚本猫-安装-orange)](https://scriptcat.org/zh-CN/script-show-page/你的脚本ID)
...
[![ScriptCat Install](https://img.shields.io/badge/点击安装-脚本猫-orange?style=for-the-badge&logo=cat)](https://scriptcat.org/zh-CN/script-show-page/你的脚本ID)

**🔴 从 Greasy Fork 安装**

[![GreasyFork Install](https://img.shields.io/badge/点击安装-Greasy%20Fork-red?style=for-the-badge)](https://greasyfork.org/zh-CN/scripts/你的脚本ID)

**⚫ 从 GitHub 直接安装**

[![GitHub Install](https://img.shields.io/badge/点击安装-GitHub-black?style=for-the-badge&logo=github)](https://raw.githubusercontent.com/你的用户名/仓库名/main/鼠标悬停图片自动放大预览.user.js)
...
- 🐛 发现问题？[提交 Issue](https://github.com/你的用户名/仓库名/issues)
- 💡 功能建议？欢迎开 Issue 讨论
- 🔧 欢迎提交 Pull Request
